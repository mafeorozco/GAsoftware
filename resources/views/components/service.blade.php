    ...
    <div class="container mx-auto px-16 items-center flex flex-col lg:flex-row">
        <div class="lg:w-1/2">
            <div class="lg:pr-32 xl:pr-48">
                <h3 class="text-3xl font-semibold leading-tight">Nuestros servicios</h3>
                <p class="mt-8 text-xl font-light leading-relaxed">Ofresemos una amplia bariedad de productos para que su institucion este a la altura de las mejores del pais.
                </p>
            </div>
        </div>
