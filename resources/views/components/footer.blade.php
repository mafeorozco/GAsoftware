<section id="contact" class="text-gray-600 body-font relative">
    <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
      <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
        ...
        <div class="bg-white w-full relative flex flex-wrap py-6 rounded shadow-md">
          <div class="lg:w-1/2 px-6">
            ...
            <p class="mt-1">Cali valle del cauca</p>
          </div>
          <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
            <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">Correo</h2>
            <a class="text-blue-500 leading-relaxed">gestionacademica@email.com</a>
      ...
      <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
        ...
        <p class="leading-relaxed mb-5 text-gray-600">Dejanos un mensaje y te contactaremos para que resibas mas información.</p>
        ...
        <button class="text-white bg-sky-400 border-0 py-2 px-6 focus:outline-none hover:bg-slate-700 hover:text-slate-50 rounded text-lg">Enviar</button>
        <p class="text-xs text-gray-500 mt-3">Gestion academica 2024</p>
      </div>
    </div>
  </section>