                                    ...
                                    <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                                        <div class="overflow-hidden">
                                            <table class="min-w-full text-left text-sm font-light text-surface">
                                                ...
                                                <tbody>
                                                    @foreach ($dataUsuarios as $usuarios)
                                                    <tr class="border-b border-neutral-200">
                                                        <td class="whitespace-nowrap px-6 py-4 font-medium">
                                                            {{ $usuarios['id'] }}</td>
                                                        <td class="whitespace-nowrap px-6 py-4">{{ $usuarios['name']}}
                                                        </td>
                                                        <td class="whitespace-nowrap px-6 py-4">{{ $usuarios['role']}}
                                                        </td>
                                                        <td class="whitespace-nowrap px-6 py-4">{{ $usuarios['email']}}
                                                        </td>
                                                        <td>
                                                        <button onclick="openModalEdit(this)"
                                                                data-id="{{ $usuarios['id'] }}"
                                                                class="inline-flex items-center bg-sky-400 border-0 py-1 px-3 focus:outline-none hover:bg-gray-500 text-white rounded text-base mt-4 md:mt-0"">Editar</button>
                                                        </td>  
                                                        
                                                        
                                                    </tr>
                                                    <div id="modal-edit-container{{$usuarios['id']}}" class="hidden fixed inset-0">
                                                                                        ...
                                                                                        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                                                                            <div class="-mx-3 mb-6">
                                                                                                <div class="md:w-full px-3">
                                                                                                    <input name="usuario_id" class="hidden" value="{{$usuarios['id']}}">
                                                                                                </div>
                                                                                                <div class="md:w-full px-3">
                                                                                                    <label
                                                                                                    ...
                                                                                                    <select name="role" class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="role">
                                                                                                        @foreach($roles as $role)
                                                                                                            @if($role->name == $usuarios['role'])
                                                                                                ...
                                                                                                <div class="md:w-full px-3">
                                                                                                    ...
                                                                                                    <input
                                                                                                        ...
                                                                                                        id="name" name="name"
                                                                                                        type="text" placeholder="Nombre" value="{{$usuarios['name']}}">
                                                                                                </div>
                                                                                                <div class="md:w-full px-3">
                                                                                                    <label
                                                                                                        class="uppercase tracking-wide text-black text-xs font-bold mb-2"
                                                                                                    ...
                                                                                                    <input
                                                                                                        class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3"
                                                                                                        id="email" name="email"
                                                                                                        type="text" placeholder="Email" value="{{$usuarios['email']}}">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        </div>
                                                                                                ...
                                                                                                <div class="modal-actions bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                                                                                    ...
                                                                                                    <button onclick="closeModalEdit(this)"
                                                                                        data-id="{{ $usuarios['id'] }}"
                                ...
                                <div
                                    ...
                                    <div id="modal-container"
                                        ...
                                        <div class="modal-wrapper bg-white px-4 pt-5 pb-4 sm:p-6 sm:pd-4">
                                            <div class="modal-wrapper-flex sm:flex sm:item-start">
                                                <div
                                                    class="modal-icon mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-sky-400  sm:mx-0 sm:h-10 sm:w-10">
                                                    <i class="fa fa-school fa-2x fa-inverse"></i>
                                                </div>
                                                <div
                                                    class="modal-content text-center mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div
                                            ...
                                            <button id="closeModal"
                                                class="w-full inline-flex justify-center rounded-md border border-transparent shadow-md px-4 py-2 bg-sky-400 font-medium text-gray-50 hover:bg-gray-700 hover:text-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"><i
