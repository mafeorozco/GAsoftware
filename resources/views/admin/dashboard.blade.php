                ...
                <div class="flex flex-wrap w-full">
                            ...
                            <div class="bg-gradient-to-b from-blue-200 to-blue-100 border-b-4 border-sky-400 rounded-lg shadow-xl p-5">
                                <div class="flex flex-row items-center">
                                    <div class="flex-shrink pr-4">
                                        <div class="rounded-full p-5 bg-sky-400"><i class="fa fa-school fa-2x fa-inverse"></i></div>
                                    </div>
                                    <div class="flex-1 text-right md:text-center">
                                        <h2 class="font-bold uppercase text-gray-600">Entidades</h2>
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-5">
                        ...
                        <div class="bg-gradient-to-b from-blue-200 to-blue-100 border-b-4 border-sky-400 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                <div class="flex-shrink pr-4">
                                    <div class="rounded-full p-5 bg-sky-400"><i class="fas fa-chart-area fa-2x fa-inverse"></i></div>
                                </div>
                                <div class="flex-1 text-right md:text-center">
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-5">
                        ...
                        <div class="bg-gradient-to-b from-blue-200 to-blue-100 border-b-4 border-sky-400 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                <div class="flex-shrink pr-4">
                                    <div class="rounded-full p-5 bg-sky-400"><i class="fa fa-envelope fa-2x fa-inverse"></i></div>
                                </div>
                                <div class="flex-1 text-right md:text-center">
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-5">
                        <!--Metric Card-->
                        <a href="{{ route ('grado.index') }}">
                            <div class="bg-gradient-to-b from-blue-200 to-blue-100 border-b-4 border-sky-400 rounded-lg shadow-xl p-5">
                                <div class="flex flex-row items-center">
                                    <div class="flex-shrink pr-4">
                                        <div class="rounded-full p-5 bg-sky-400"><i class="fa fa-graduation-cap fa-2x fa-inverse"></i></div>
                                    </div>
                                    <div class="flex-1 text-right md:text-center">
                                        <h2 class="font-bold uppercase text-gray-600">Grados</h2>
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-5">
                        ...
                        <a href="{{ route ('area.index') }}">
                            <div class="bg-gradient-to-b from-blue-200 to-blue-100 border-b-4 border-sky-400 rounded-lg shadow-xl p-5">
                                <div class="flex flex-row items-center">
                                    <div class="flex-shrink pr-4">
                                        <div class="rounded-full p-5 bg-sky-400"><i class="fa fa-square-root-alt fa-2x fa-inverse"></i></div>
                                    </div>
                                    <div class="flex-1 text-right md:text-center">
                                        <h2 class="font-bold uppercase text-gray-600">Areas</h2>
                                    </div>
                                </div>
                            </div>
                        </a>
