      ...
      <section class="pt-20 md:pt-40">
          <div class="container mx-auto px-8 lg:flex">
              <div class="text-center lg:text-left lg:w-1/2">
                  <h1 class="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">¿Que hacemos en gestión academica?</h1>
                  <p class="text-xl lg:text-2xl mt-6 font-light">
                    En gestión academica tenemos un modelo que permitira que su institusion este a otro nivel y tenga los resultados que esteras.
                  </p>
                  <p class="mt-8 md:mt-12">
                      <button type="button"
                          class="py-3 px-8 text-sm bg-sky-400 hover:bg-slate-700 hover:text-slate-50 rounded text-white">Conoce nuestros planes</button>
                  </p>
              </div>
